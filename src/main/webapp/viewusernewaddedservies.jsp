...
<form method="get" action="viewaddedservice" class="filter-form">
...
<div class="card-container">
    <c:forEach items="${services}" var="services">
        <div class="card">
            ...
            <h3>Title: <b><c:out value="${services.title}" /></b>
            <h3>Location:<b><c:out value="${services.location}" /></h3></b>
            <h3>Description:<b> <c:out value="${services.description}" /></h3></b>
            <h3>Date of Added:<b> <c:out value="${services.date}" /></h3></b>
        </div>
    </c:forEach>
</div>
</body>
